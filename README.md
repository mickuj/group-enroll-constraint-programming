...
Soon you will be able to check the :boxing_glove: [the competition scoreboard on wiki](https://gitlab.com/agh-courses/25/cp/project-a-group-enroll/-/wikis/Scoreboard). :boxing_glove:
